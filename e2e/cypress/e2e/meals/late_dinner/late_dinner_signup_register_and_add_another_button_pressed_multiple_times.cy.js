...
describe(
  "When an admin user signs a guest up for late dinner and clicks the register and add another button multiple times",
  { testIsolation: false },
  () => {
    ...
    it("only one meal will be created", function () {
      ...
      Cypress._.times(5, () => {
        getDataTestIdElement(
          "late-signup-register-and-add-another-button",
        ).click();
      });
      getDataTestIdElement("late-signup-cancel-button").click();
